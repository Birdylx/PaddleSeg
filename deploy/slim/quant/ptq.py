...
def parse_args():
    ...
    parser.add_argument(
        ...
        dest='batch_nums',
        help=
        'number of iterations. If set to None , it will run until the end of the sample_generator iteration, otherwise, the number of iterations is batch_nums, that is, the number of samples involved in Scale correction is batch_nums * batch_size .',
        type=int,
        default=10)
...
def main(args):
    ...
    # copy yml
    shutil.copyfile(os.path.join(fp32_model_dir, 'deploy.yaml'),
