...
def parse_train_args(*args, **kwargs):
    ...
    parser.add_argument(
        ...
        choices=["O1", "O2"],
        help=
        "Auto mixed precision level. Accepted values are “O1” and “O2”: On O1 level, the input \
    ...
    parser.add_argument(
        ...
        type=str,
        help=
        "Options of the training profiler. If `profiler_options` is not None, the training profiler will be enabled. Refer to `paddleseg/utils/train_profiler.py` for details."
    )
    parser.add_argument('--seed', help="Random seed.", default=None, type=int)
    parser.add_argument('--opts',
                        help="Update the key-value pairs of existing options.",
                        nargs='+')
