...
def main():
    model = VNetModel(
        ...
        num_classes=1,
        pretrained=
        "/ssd2/tangshiyu/Code/EISeg-3D/experiments/3D_interseg/mrispineseg_vnet/174/checkpoints/049.pdparams",  # "pretrained_models/vnet_model.pdparams",
    ...
    new_net = paddle.jit.to_static(
        model,
        input_spec=[
            paddle.static.InputSpec(shape=[None, 1, None, None, None],
                                    dtype="float32"),
            paddle.static.InputSpec(shape=[None, 3, None, None, None],
